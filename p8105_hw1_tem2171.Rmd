...
mean random sample: 0.24
mean vec_logical:0.6
mean vec_char: argument is not numeric or logical: returning NA
mean vec_factor:argument is not numeric or logical: returning NA
